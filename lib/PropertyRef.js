...
class PropertyRef {
    ...
    fullColumnName() {
        ...
        if (relation) {
            ...
            // Check if columName as an alias defined in model
            const columnName = modelClass.columnNameAlias?.[_.camelCase(this.columnName)] || this.columnName;

            // Tablename may have a schema prefixed
            return modelClass.getTableName().replace('.', '__') + '_alias.' + columnName;
        } else {
